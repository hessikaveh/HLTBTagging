...
process.hltPFJetForBtagSelector.MinN = cms.int32(3)
process.hltPFJetForBtagSelector.MaxEta = cms.double(3.15101187488)
...
process.hltPFJetForBtagSelector.MinPt = cms.double(5.82764717682)

process.hltDeepBLifetimeTagInfosPF.maximumTransverseImpactParameter = cms.double(0.463117212064)
process.hltDeepBLifetimeTagInfosPF.minimumNumberOfHits = cms.int32(6)
process.hltDeepBLifetimeTagInfosPF.minimumTransverseMomentum = cms.double(8.2181852717)
process.hltDeepBLifetimeTagInfosPF.maximumLongitudinalImpactParameter = cms.double(22.1109338829)
process.hltDeepBLifetimeTagInfosPF.maxDeltaR = cms.double(0.900588522267)
process.hltDeepBLifetimeTagInfosPF.minimumNumberOfPixelHits = cms.int32(5)
process.hltDeepBLifetimeTagInfosPF.ghostTrackPriorDeltaR = cms.double(0.722032852474)
process.hltDeepBLifetimeTagInfosPF.maximumChiSquared = cms.double(6.69940496643)

process.hltDeepInclusiveVertexFinderPF.fitterSigmacut = cms.double(3.58772911361)
process.hltDeepInclusiveVertexFinderPF.vertexReco.primcut = cms.double(2.14229838788)
process.hltDeepInclusiveVertexFinderPF.vertexReco.seccut = cms.double(9.14653458186)
process.hltDeepInclusiveVertexFinderPF.fitterTini = cms.double(121.3757149)
process.hltDeepInclusiveVertexFinderPF.fitterRatio = cms.double(0.481877343586)
process.hltDeepInclusiveVertexFinderPF.vertexMinDLen2DSig = cms.double(3.1215928726)
process.hltDeepInclusiveVertexFinderPF.maximumLongitudinalImpactParameter = cms.double(22.1109338829)
process.hltDeepInclusiveVertexFinderPF.vertexMinAngleCosine = cms.double(0.256365067368)
process.hltDeepInclusiveVertexFinderPF.maxNTracks = cms.uint32(20)
process.hltDeepInclusiveVertexFinderPF.clusterizer.distanceRatio = cms.double(1.4626936553)
process.hltDeepInclusiveVertexFinderPF.clusterizer.clusterMaxDistance = cms.double(0.697033015464)
process.hltDeepInclusiveVertexFinderPF.clusterizer.clusterMaxSignificance = cms.double(8.60565137167)
process.hltDeepInclusiveVertexFinderPF.clusterizer.seedMin3DIPSignificance = cms.double(8.94296779202)
process.hltDeepInclusiveVertexFinderPF.clusterizer.clusterMinAngleCosine = cms.double(0.995787104184)
process.hltDeepInclusiveVertexFinderPF.clusterizer.seedMin3DIPValue = cms.double(0.589451035908)
process.hltDeepInclusiveVertexFinderPF.vertexMinDLenSig = cms.double(4.96961743798)
process.hltDeepInclusiveVertexFinderPF.minHits = cms.uint32(7)
process.hltDeepInclusiveVertexFinderPF.minPt = cms.double(27.7466843456)
process.hltDeepInclusiveSecondaryVerticesPF.minSignificance = cms.double(9.1619300634)
process.hltDeepInclusiveSecondaryVerticesPF.maxFraction = cms.double(0.633447633359)
process.hltDeepTrackVertexArbitratorPF.fitterSigmacut = cms.double(3.58772911361)
process.hltDeepTrackVertexArbitratorPF.fitterTini = cms.double(121.3757149) 
process.hltDeepTrackVertexArbitratorPF.trackMinLayers = cms.int32(8)
process.hltDeepTrackVertexArbitratorPF.fitterRatio = cms.double(0.481877343586)
process.hltDeepTrackVertexArbitratorPF.sigCut = cms.double(0.824460629289)
process.hltDeepTrackVertexArbitratorPF.distCut = cms.double(0.144245837542)
process.hltDeepTrackVertexArbitratorPF.trackMinPt = cms.double(25.3699909842)
process.hltDeepTrackVertexArbitratorPF.dLenFraction = cms.double(0.399045790821)
process.hltDeepTrackVertexArbitratorPF.trackMinPixels = cms.int32(9)
process.hltDeepTrackVertexArbitratorPF.dRCut = cms.double(0.0679887666419)
process.hltDeepInclusiveMergedVerticesPF.minSignificance = cms.double(9.1619300634)
process.hltDeepInclusiveMergedVerticesPF.maxFraction = cms.double(0.633447633359)
process.hltDeepSecondaryVertexTagInfosPF.extSVDeltaRToJet = cms.double(0.619257220722)
process.hltDeepSecondaryVertexTagInfosPF.vertexReco.primcut = cms.double(2.14229838788)
process.hltDeepSecondaryVertexTagInfosPF.vertexReco.seccut = cms.double(9.14653458186)
process.hltDeepSecondaryVertexTagInfosPF.vertexReco.weightthreshold = cms.double(0.092343657273)
process.hltDeepSecondaryVertexTagInfosPF.vertexReco.minweight = cms.double(0.103274111743)
process.hltDeepSecondaryVertexTagInfosPF.vertexCuts.distSig2dMin = cms.double(9.56730954379)
process.hltDeepSecondaryVertexTagInfosPF.vertexCuts.massMax = cms.double(13.0077137024)
process.hltDeepSecondaryVertexTagInfosPF.vertexCuts.distVal2dMin = cms.double(0.122503154482)
process.hltDeepSecondaryVertexTagInfosPF.vertexCuts.minimumTrackWeight = cms.double(0.691514306368)
process.hltDeepSecondaryVertexTagInfosPF.vertexCuts.v0Filter.k0sMassWindow  = cms.double(0.483509419512)
process.hltDeepSecondaryVertexTagInfosPF.vertexCuts.fracPV = cms.double(0.868295642131)
process.hltDeepSecondaryVertexTagInfosPF.vertexCuts.maxDeltaRToJetAxis = cms.double(0.596404041389)
process.hltDeepSecondaryVertexTagInfosPF.vertexCuts.distVal2dMax = cms.double(0.451493277464)
process.hltDeepSecondaryVertexTagInfosPF.vertexCuts.multiplicityMin = cms.uint32(6)
process.hltDeepSecondaryVertexTagInfosPF.minimumTrackWeight = cms.double(0.691514306368)
process.hltDeepSecondaryVertexTagInfosPF.trackSelection.max_pT_dRcut = cms.double(0.798105563045)
process.hltDeepSecondaryVertexTagInfosPF.trackSelection.b_dR = cms.double(0.322446788227)
process.hltDeepSecondaryVertexTagInfosPF.trackSelection.min_pT = cms.double(95.446968486)
process.hltDeepSecondaryVertexTagInfosPF.trackSelection.b_pT = cms.double(0.820142723186)
process.hltDeepSecondaryVertexTagInfosPF.trackSelection.ptMin = cms.double(23.1943758313)
process.hltDeepSecondaryVertexTagInfosPF.trackSelection.max_pT_trackPTcut = cms.double(24.7679039075)
process.hltDeepSecondaryVertexTagInfosPF.trackSelection.max_pT = cms.double(281.463587576)
process.hltDeepSecondaryVertexTagInfosPF.trackSelection.a_dR = cms.double(0.0749897877725)
process.hltDeepSecondaryVertexTagInfosPF.trackSelection.maxDistToAxis = cms.double(2.32267681713)
process.hltDeepSecondaryVertexTagInfosPF.trackSelection.totalHitsMin = cms.uint32(3)
process.hltDeepSecondaryVertexTagInfosPF.trackSelection.a_pT = cms.double(0.211744941817)
process.hltDeepSecondaryVertexTagInfosPF.trackSelection.min_pT_dRcut = cms.double(0.0050869022271)
process.hltDeepSecondaryVertexTagInfosPF.trackSelection.jetDeltaRMax = cms.double(0.0164231960841)
process.hltDeepSecondaryVertexTagInfosPF.trackSelection.pixelHitsMin = cms.uint32(7)

process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPairV0Filter.k0sMassWindow = cms.double(0.483509419512)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.pseudoMultiplicityMin = cms.uint32(2)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.minimumTrackWeight = cms.double(0.691514306368) 
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.charmCut = cms.double(5.19804089121) 
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.max_pT_dRcut = cms.double(0.798105563045) 
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.b_dR = cms.double(0.322446788227) 
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.min_pT = cms.double(95.446968486)   
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.b_pT = cms.double(0.820142723186)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.ptMin = cms.double(23.1943758313)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.max_pT_trackPTcut = cms.double(24.7679039075)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.max_pT = cms.double(281.463587576) 
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.a_dR = cms.double(0.0749897877725) 
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.maxDistToAxis = cms.double(2.32267681713) 
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.totalHitsMin = cms.uint32(3)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.a_pT = cms.double(0.211744941817)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.min_pT_dRcut = cms.double(0.0050869022271)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.jetDeltaRMax = cms.double(0.0164231960841) 
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.pixelHitsMin = cms.uint32(7) 
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.maxDecayLen = cms.double(5.24954229639)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackPseudoSelection.sip2dSigMin = cms.double(6.12937422085)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.max_pT_dRcut = cms.double(0.798105563045) 
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.b_dR = cms.double(0.322446788227) 
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.min_pT = cms.double(95.446968486) 
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.b_pT = cms.double(0.820142723186)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.ptMin = cms.double(23.1943758313)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.max_pT_trackPTcut = cms.double(24.7679039075)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.max_pT = cms.double(281.463587576)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.a_dR = cms.double(0.0749897877725) 
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.maxDistToAxis = cms.double(2.32267681713)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.totalHitsMin = cms.uint32(3)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.a_pT = cms.double(0.211744941817)  
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.min_pT_dRcut = cms.double(0.0050869022271)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.jetDeltaRMax = cms.double(0.0164231960841)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.pixelHitsMin = cms.uint32(7)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackSelection.maxDecayLen = cms.double(5.24954229639)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.pseudoVertexV0Filter.k0sMassWindow = cms.double(0.483509419512)
process.hltDeepCombinedSecondaryVertexBJetTagsInfos.computer.trackMultiplicityMin = cms.uint32(0)
